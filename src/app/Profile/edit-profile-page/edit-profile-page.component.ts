...
//   //Constructor
//   constructor(private router:Router,private jwtService: JwtserviceService, private apiCall:UserApiCallsService,private el: ElementRef){}
...
//   //   if (selectedFile) {
//   //     const objectUrl = URL.createObjectURL(selectedFile);
//   //     this.editProfForm.get('myObject.editImage')?.setValue(objectUrl);
//   //   }
//   // }
//   onImageSelected(event: Event) {
//     const inputElement = this.el.nativeElement.querySelector('#imageInput') as HTMLInputElement;
...
//   //Function for submission of form: To post data to db through API
//   onSubmission():void{
